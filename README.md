...
It is also inspired by [Tsodin's](https://github.com/tsoding) series on [software rendering](https://www.youtube.com/playlist?list=PLpM-Dvs8t0Va-Gb0Dp4d9t8yvNFHaKH6N).
...
I'm still working on adding new features and optimizing the pipeline. The current code uses a struct that implements the GameState trait to separate the engine and to process the game logic.
